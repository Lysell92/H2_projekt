    ...
    return (
        <div className="container">
            <div id="model_accuracy" className="carousel slide" data-bs-ride="carousel">
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#model_accuracy" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#model_accuracy" data-bs-slide="next">
            ...
            <div className="container-fluid mt-2">
                <h3 className="text-center fw-semibold mb-4 text-dark">To grafer som viser, hvordan min model blev trænet. Igennem 49 epoker kan man se, hvordan resultaterne forbedres og hvordan modellen tilpassede sig datasettet.</h3>
            </div>
        </div>
    );
};
